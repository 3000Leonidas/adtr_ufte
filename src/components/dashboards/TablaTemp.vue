...
import { recentTemperatura } from '@/data/dashboard/dashboardData';
</script>
<template>
    <!--esta es la tabla de horas -->
    <v-card elevation="10" class="withbg">
        <v-card-item class="pb-0">
            <v-card-title class="text-h5 pt-sm-2">Temperatura Time</v-card-title>
            <div class="recent-transaction mt-10 px-3">
                <div v-for="list in recentTemperatura" :key="list.title">
